...
String T= "Roy's Grahpical User Interface For Robots V2.0"; // Creating word strings for the interface.
String T1= "FWD";
String T2= "RHT";
String T3= "LFT";
String T4= "BWD";
...
void setup()
{
  size(1500,600); // Creating the display window and defining its' size.
